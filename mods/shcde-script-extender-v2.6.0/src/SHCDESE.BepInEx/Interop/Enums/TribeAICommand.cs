...
public enum TribeAICommand : UInt32
{
    Unknown0 = 0,
    Unknown1 = 1,
    Unknown2 = 2,
    MoveHerePosition = 3,       // Move unit to tile position, r9 = tileX, Stack1 = tileY
    AttackUnit = 4,             // Attack Unit as melee/or ranged) r9 = TargetUnitId, Stack1 = TargetUnitGlobalId
    AttackTilePosition = 5,     // Attack Here: Ranged -> Place r9 = tileX, Stack1 = tileY, <- forced attack for attackers (range/melee), a6 = ? (15 on catapults)
    ...
    Unknown8 = 8,
    AttackBuilding = 9,         // Attack Building as melee/Ranged r9 = BuildingId, Stack1 = TargetBuildingGlobalId
    Unknonw10 = 10,
    Unknown11 = 11,
    Unknown12 = 12,
    Unknown13 = 13,
    ...
    Unknown22 = 22,
    AttackWallTileId = 23,      // Attack Wall as melee r9 = TileId  (also counts for siege tower -> wall attach), Stack1 = Unused
    ...
    Unknown35 = 35,
    ForceAttackBuilding = 36,   // Attack Here: melee/Ranged -> Building r9 = BuildingId, Stack1 = TargetGlobalId, a6 = -127
